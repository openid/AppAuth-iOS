...
//! Project version number for AppAuthCore.
FOUNDATION_EXPORT double AppAuthCoreVersionNumber;

//! Project version string for AppAuthCore.
FOUNDATION_EXPORT const unsigned char AppAuthCoreVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <AppAuth_core_iOS/PublicHeader.h>
