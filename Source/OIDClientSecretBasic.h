...
/*! @brief Parameter value for the token endpoint authentication method 'client_secret_basic'.
 */
extern NSString *const OIDClientSecretBasicName;

@interface OIDClientSecretBasic : NSObject <OIDClientAuthentication>
/*! @internal
