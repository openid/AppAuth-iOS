...
/*! @fn initWithConfiguration:grantType:authorizationCode:redirectURL:clientID:scopes:refreshToken:additionalParameters:
...
/*! @fn initWithConfiguration:grantType:authorizationCode:redirectURL:clientID:scope:refreshToken:additionalParameters:
