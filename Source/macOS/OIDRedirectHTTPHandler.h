/*! @file OIDAuthorizationFlowSession.h
 ...
 */
- (nullable instancetype)initWithSuccessURL:(NSURL *)successURL;

/*! @fn startHTTPListener:
    @brief Starts listening on the loopback interface and returns a URL with the address.
