...
+ (OIDRegistrationRequest *)testInstance {
  NSDictionary *additionalParameters = @{kTestAdditionalParameterKey : kTestAdditionalParameterValue};
  OIDRegistrationRequest *request =
          [[OIDRegistrationRequest alloc] initWithConfiguration:[OIDServiceConfigurationTests testInstance]
...
- (void)testCopying {
  ...
  XCTAssertEqualObjects(request.tokenEndpointAuthenticationMethod, kTokenEndpointAuthMethodTestValue);
  ...
  XCTAssertEqualObjects(requestCopy.tokenEndpointAuthenticationMethod, request.tokenEndpointAuthenticationMethod);
...
- (void)testURLRequest {
  ...
  XCTAssertEqualObjects(parsedJSON[OIDRedirectURIsParam][0], [request.redirectURIs[0] absoluteString]);
  ...
  XCTAssertEqualObjects(parsedJSON[OIDTokenEndpointAuthenticationMethodParam], request.tokenEndpointAuthenticationMethod);
