...
You'll need to have [Carthage](https://github.com/Carthage/Carthage) installed in order to pull AppAuth dependency.

So first run `carthage bootstrap` to build AppAuth framework then open the `Example.xcworkspace` file.
