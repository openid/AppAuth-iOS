...
This example uses the local AppAuth Swift Package, which is referenced via a relative path (`../..`). Xcode resolves this automatically and no `carthage bootstrap` is needed.

To get started, just open the `Example.xcodeproj` file.
...
may view the IdP-specific information in the [main README](../README.md#openid-certified-providers).
