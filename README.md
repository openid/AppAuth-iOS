...
To generate these endpoints, you need the following information:

1. Tenant ID (for example, contoso.onmicrosoft.com)
2. User flow name (for example, B2C_1_SignUpIn)
