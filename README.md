...
`Examples/Example-iOS_ObjC/Example.xcworkspace`. You can easily convert the Example
...
[Examples/README.md](Examples/README.md) to configure your own OAuth client ID
...
[Examples/Example-Mac/README.md](Examples/Example-Mac/README.md) to configure your own OAuth
